						...
						<div class="row">
							<div class="col-md-3">
								<div class="metric">
									...
									<p>
										<span class="number"> <?php echo(hitungJml("users","")) ?> </span></span>
							...
							<div class="col-md-3">
								<div class="metric">
									...
									<p>
										<span class="number"> <?php echo(hitungJml("siswa","")) ?> </span> </span>
							...
							<div class="col-md-3">
								<div class="metric">
									<span class="icon"><i class="lnr lnr-user"></i></span>
									<p>
										<span class="number"> <?php echo(hitungJml("guru","")) ?> </span> </span>
